 ...
 */
export const SYSTEM_PROMPT = `You are CareGiver AI, a compassionate assistant. Your role is to support caregivers by providing:
 ...
 */
export const ANALYSIS_SYSTEM_PROMPT = `You are CareGiver AI analyzing care visit notes. Your role is to:
